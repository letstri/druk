...
export const GRAMMARS = {
  bash: { query: bashQuery, wasm: bashWasm },
  c: { query: cQuery, wasm: cWasm },
  cpp: { query: cppQuery, wasm: cppWasm },
  csharp: { query: csharpQuery, wasm: csharpWasm },
  css: { query: cssQuery, wasm: cssWasm },
  dart: { query: dartQuery, wasm: dartWasm },
  elixir: { query: elixirQuery, wasm: elixirWasm },
  go: { query: goQuery, wasm: goWasm },
  html: { query: htmlQuery, wasm: htmlWasm },
  java: { query: javaQuery, wasm: javaWasm },
  json: { query: jsonQuery, wasm: jsonWasm },
  kotlin: { query: kotlinQuery, wasm: kotlinWasm },
  lua: { query: luaQuery, wasm: luaWasm },
  php: { query: phpQuery, wasm: phpWasm },
  python: { query: pythonQuery, wasm: pythonWasm },
  ruby: { query: rubyQuery, wasm: rubyWasm },
  rust: { query: rustQuery, wasm: rustWasm },
  scala: { query: scalaQuery, wasm: scalaWasm },
  solidity: { query: solidityQuery, wasm: solidityWasm },
  swift: { query: swiftQuery, wasm: swiftWasm },
  toml: { query: tomlQuery, wasm: tomlWasm },
  tsx: { query: tsxQuery, wasm: tsxWasm },
  vue: { query: vueQuery, wasm: vueWasm },
