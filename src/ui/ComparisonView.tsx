...
export function ComparisonView(props: ComparisonViewProps) {
  ...
  useKeys((key: KeyEvent, k: string) => {
    if (props.blocked || !props.focused || key.defaultPrevented || text()) {
      return
    }
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              ...
              <text
                ...
                fg={ui.faint}
                bg={ui.solidBarBg}
                content={`${detail().stats.files} files · ${plural(parents(), 'parent')} · ←→ files · Esc back`}
              />
            </box>
          )
        }}
      ...
      <Show
        when={props.file}
        fallback={<Message title="No file changes in this commit." />}
      >
          ...
          <Show
            ...
            fallback={
              ...
              >
                ...
                <Show
                  when={props.content}
                  fallback={<Message title="Loading the diff…" />}
                >
                  <Message
                    title="Binary file"
                    detail="A textual diff is not available."
                  />
                </Show>
              </box>
            }
    ...
    >
      ...
      <Show when={props.detail}>
        {(detail: Accessor<string>) => (
          <text fg={ui.dim} bg={ui.solidBg} content={detail()} />
        )}
      </Show>
